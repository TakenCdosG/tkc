...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
    <?php
      ...
      foreach ($node->field_album['und'] as $key => $value){
          
          $nodo = node_load($node->field_album['und'][$key]['nid']);
            ...
            print "<li class='field'><a href='/node/".drupal_get_path_alias($nodo->nid)."'>";
                    ...
                    $urlf = custom_flickr_primaryphoto($nodo->field_flickr_set_id['und'][0]['value']);
                     print theme('imagecache_external', array('path' => $urlf, 'style_name'=> 'albumsgallery'));
                    print "</div>";
